...
reg.test<-lm(target ~ pblack + pwhite + medInc + int.pbl.inc + int.pwh.inc) 
...
stargazer(reg.test, summary=TRUE, header=FALSE, nobs=FALSE, digits=0, align=T, style='qje', title=paste0('Percent Change in Regression Summary'))
